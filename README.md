Essa aplicação é capaz de gerir uma padaria:
- Cadastro e manipulação de usuários;
- Gestão de estoque de matérias-primas;
- Gestão de produtos produzidos na padaria;
- Gestão de produtos tercerizados de revenda;
- Gestão de estoque geral;
- Gestão de caixa e de vendas.
